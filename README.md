...
3. Set amount and external reference. Optionally choose network and token.
4. If network is omitted, the customer selects on the payment page
5. The response includes the watch address and QR code (or payment URL if network was omitted)
...
- [API Reference](https://docs.payzcore.com)
