...
export class PayzCoreTrigger implements INodeType {
  ...
  async webhook(this: IWebhookFunctions): Promise<IWebhookResponseData> {
    ...
    if (verifySignature) {
      ...
      if (!timestamp) {
        return { webhookResponse: 'Missing timestamp header', statusCode: 401 } as any;
      }
      ...
      if ((req as any).rawBody) {
        ...
        return { webhookResponse: 'Cannot verify signature: raw body unavailable', statusCode: 401 } as any;
      }
